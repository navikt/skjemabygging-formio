...
| innsending          | submission                     | Use `application` when referring to the application being submitted, not the act, method, or process of submitting it.                                                                          |
| innsendings-ID      | application ID                 | Prefer `applicationId` internally. Keep `innsendingsId` when it is a field or identifier from the SendInn API.                                                                                  |
