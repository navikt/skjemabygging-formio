...
const organizationNumberForm = () => {
  const formNumber = 'organizationnumber';

  return form({
    title: 'OrganizationNumber component test form',
...
const organizationNumberTranslations = () => getMockTranslationsFromForm(organizationNumberForm());

export { organizationNumberForm, organizationNumberTranslations };
