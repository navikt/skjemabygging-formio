...
const dataFetcherCheckConditionForm = () =>
  form({
    title: 'Tester utils checkCondition',
    formNumber: 'TST 19-81.05',
    path: 'datafetchercheckcondition',
    components: [
      panel({
        key: 'veiledning',
        title: 'Veiledning',
...
const dataFetcherCheckConditionTranslations = () => getMockTranslationsFromForm(dataFetcherCheckConditionForm());

export { dataFetcherCheckConditionForm, dataFetcherCheckConditionTranslations };
