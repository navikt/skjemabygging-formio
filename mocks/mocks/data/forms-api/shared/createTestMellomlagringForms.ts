const baseForm = {
  _id: '63f8ad991fefba14a5dc27d1',
  title: 'Test mellomlagring',
  name: 'testmellomlagring',
  path: 'testmellomlagring',
  type: 'form',
  display: 'wizard',
  tags: ['nav-skjema', ''],
      ...
      components: [
        ...
        },
        {
          ...
          components: [
            ...
            {
              label: 'Hva spiste du til frokost?',
              fieldSize: 'input--xxl',
              labelWidth: '',
              labelMargin: '',
              description: '',
    ...
    },
    {
      ...
      components: [
        ...
        },
        {
          ...
          conditional: {
            show: true,
            when: 'onskerDuAFaGavenInnpakket',
            eq: 'ja',
            json: '',
          },
          customConditional: '',
  ...
  properties: {
    skjemanummer: 'test-mellomlagring',
    tema: 'BAR',
    ...
    signatures: [
      {
        label: '',
        description: '',
        key: '1b0dd061-b505-4665-9037-a7e66e279c18',
      },
    ],
    isTestForm: true,
    modified: '2023-08-30T12:17:45.811Z',
    modifiedBy: 'Mock',
  ...
  submissionAccess: [],
  created: '2023-02-24T12:29:13.488Z',
  modified: '2023-08-30T12:17:46.722Z',
  machineName: 'jvcemxwcpghcqjn:testmellomlagring',
};
