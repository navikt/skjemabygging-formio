const baseForm = {
  _id: '65c5fb2df4cdb19cc1e4ffa7',
  title: 'Tester nedtrekksmeny',
  name: 'testSelect',
  path: 'testselect',
  type: 'form',
  display: 'wizard',
  ...
  access: [
    ...
    {
      type: 'update_all',
      roles: ['628ca77305690db58c974d05', '628ca77305690db58c974d06'],
    },
  ],
  owner: 'G123456',
  components: [
    {
      ...
      components: [
        ...
        },
        {
          ...
          dataSrc: 'url',
          data: {
            url: 'http://localhost:3001/fyllut/api/countries?lang=nb',
          },
          disableLimit: true,
          id: 'eupbhut',
          defaultValue: null,
        ...
        },
        {
          ...
          dataSrc: 'url',
          data: {
            url: 'http://localhost:3001/fyllut/api/common-codes/currencies?lang=nb',
          },
          disableLimit: true,
          id: 'edyinrd',
          defaultValue: null,
    ...
    signatures: [
      {
        label: '',
        description: '',
        key: 'f75c7daa-c496-438e-b39f-b9cf6dfe6312',
      },
    ],
    isTestForm: false,
    modified: '2024-02-09T10:39:19.651Z',
    modifiedBy: 'Mock',
  },
  ...
  _vid: 0,
  submissionAccess: [],
  created: '2024-02-09T10:15:09.699Z',
  modified: '2024-02-09T10:39:20.000Z',
  machineName: 'jvcemxwcpghcqjn:testSelect',
};
