...
const WizardBuilder = NavFormioJs.Builders.builders.wizard;
class NavWizardBuilder extends WizardBuilder {
  constructor(...args) {
    super(...args);
...
// Replace 'wizard' builder with our own containing bugfix
NavFormioJs.Builders.addBuilders({ wizard: NavWizardBuilder });
