...
import form, { mapAttachmentValues, mapForm, mapInnsendingToSubmissionTypes } from './form';

const testForm: NavFormAPIType = {
  tags: [],
  type: 'test',
  display: 'form',
  name: 'Test Form',
