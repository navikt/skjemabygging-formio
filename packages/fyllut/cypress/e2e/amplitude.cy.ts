...
describe("Amplitude", () => {
  beforeEach(() => {
    ...
    cy.intercept({ method: "PUT", pathname: "/fyllut/api/send-inn/utfyltsoknad", times: 1 }, { statusCode: 200 }).as(
      "submitToSendinnSuccess",
    );
    cy.intercept({ method: "PUT", pathname: "/fyllut/api/send-inn/utfyltsoknad", times: 1 }, { statusCode: 500 }).as(
