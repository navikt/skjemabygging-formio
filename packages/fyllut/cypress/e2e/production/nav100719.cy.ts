/*
 * Production form tests for Søknad om refusjon av reiseutgifter - tekniske hjelpemidler
 * Form: nav100719
 ...
 *       hvaErFormaletMedReisen → oppgiAnnetFormalMedReisen
...
const visitPanel = (panelKey: string) => {
  visitWithFreshState(`/fyllut/nav100719/${panelKey}?sub=paper`);
};
...
const answerVedleggMinimum = () => {
  ...
  cy.findByRole('group', { name: /Kvitteringer for transportutgifter/ }).within(() => {
    cy.findByRole('radio', { name: 'Jeg ettersender dokumentasjonen senere' }).click();
  });
...
describe('nav100719', () => {
  ...
  describe('Formål conditionals', () => {
    ...
    it('shows free-text purpose only when Annet is selected', () => {
      cy.findByRole('textbox', { name: 'Oppgi annet formål med reisen' }).should('not.exist');

      selectRadioOption('Hva er formålet med reisen?', 'Annet');
      cy.findByRole('textbox', { name: 'Oppgi annet formål med reisen' }).should('exist');
  ...
  describe('Andre reiseutgifter conditionals', () => {
    ...
    it('toggles reimbursement fields from the panel questions', () => {
      ...
      selectRadioOption('Har du eller dere vært på reise i mer enn 12 timer og søker kostgodtgjørelse?', 'Ja');
      cy.findByLabelText('Hvor mange døgn søker du / dere kostgodtgjørelse for?').should('exist');

      selectRadioOption('Har du/dere hatt overnattingsutgifter?', 'Ja');
      ...
      selectRadioOption('Har du yrkesskade og hatt tapt arbeidsfortjeneste i forbindelse med reisen?', 'Ja');
    ...
    it('shows ledsager lost-income questions when ledsager expenses were requested earlier', () => {
      ...
      selectRadioOption('Har ledsager hatt tapt arbeidsinntekt i forbindelse med reisen?', 'Ja');
  ...
  describe('Vedlegg conditionals', () => {
    ...
    it('shows overnight and income attachments from Andre reiseutgifter answers', () => {
      ...
      selectRadioOption('Har du eller dere vært på reise i mer enn 12 timer og søker kostgodtgjørelse?', 'Nei');
      selectRadioOption('Har du/dere hatt overnattingsutgifter?', 'Ja');
  ...
  describe('Summary', () => {
    beforeEach(() => {
      visitWithFreshState('/fyllut/nav100719?sub=paper');
    });
    ...
    it('fills required fields and verifies summary', () => {
      ...
      selectRadioOption('Har du eller dere vært på reise i mer enn 12 timer og søker kostgodtgjørelse?', 'Nei');
      selectRadioOption('Har du/dere hatt overnattingsutgifter?', 'Nei');
      selectRadioOption('Har du yrkesskade og hatt tapt arbeidsfortjeneste i forbindelse med reisen?', 'Nei');
      cy.clickNextStep();
