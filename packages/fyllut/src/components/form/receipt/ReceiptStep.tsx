...
import { b64toBlob, useAppConfig, useLanguages } from '@navikt/skjemadigitalisering-shared-components';
import { dateUtils, Form, ReceiptSummary, stringUtils, TEXTS } from '@navikt/skjemadigitalisering-shared-domain';
import { FormHeader } from '@navikt/skjemadigitalisering-shared-frontend';
