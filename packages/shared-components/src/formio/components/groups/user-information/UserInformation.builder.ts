...
const userInformationBuilder = () => {
  return {
    title: 'Representert brukers opplysninger',
    schema: {
      type: 'container',
      key: 'brukersOpplysninger',
      label: 'Representert brukers opplysninger',
...
export default userInformationBuilder;
