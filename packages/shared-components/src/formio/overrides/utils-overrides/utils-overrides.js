...
const navFormDiffToHtml = (diffSummary) => {
  try {
    ...
    if (changesToCurrentComponent.length) {
      ...
      html.push(`<span id="${labelId}" class="aksel-body-short font-bold">Endringer</span>`);
    ...
    if (deletedComponents.length) {
      ...
      html.push(`<span id="${labelId}" class="aksel-body-short font-bold">Slettede elementer</span>`);
