const form = {
  ...
  submissionAccess: [],
  owner: '63a1877b3fc74cc275a517a5',
  components: [
    {
      title: 'Veiledning',
      type: 'panel',
      ...
      components: [
        ...
        },
        {
          ...
          values: [
            ...
            { label: 'Vinter', value: 'vinter', shortcut: '' },
          ],
          clearOnHide: true,
          customDefaultValue: '',
          calculateValue: '',
        ...
        },
        {
          labelWidth: '',
          labelMargin: '',
          content: 'Solen skinner alltid!',
          alerttype: 'info',
          isInline: false,
          contentForPdf: '',
          key: 'alertstripeArstid',
          conditional: { show: true, when: 'arstid', eq: 'vinter', json: '' },
          customConditional: '',
          type: 'alertstripe',
          label: 'Alertstripe',
          input: true,
        ...
        },
        {
          ...
          modalEdit: false,
          dataSrc: 'values',
          defaultValue: { label: 'Trommer', value: 'trommer' },
          data: {
            values: [
  ...
  properties: {
    ...
    downloadPdfButtonText: 'Last ned dokumentet',
    modified: '2023-01-18T12:42:13.388Z',
    modifiedBy: 'ann.katrin.gagnat@nav.no',
    published: '2023-01-18T11:57:16.896Z',
    publishedBy: 'ann.katrin.gagnat@nav.no',
    publishedLanguages: [],
  },
  _id: '63c7abd51578ad48a6dc00cc',
  created: '2023-01-18T08:20:37.867Z',
  modified: '2023-01-18T12:42:14.480Z',
  machineName: 'jvcemxwcpghcqjn:tst123456',
