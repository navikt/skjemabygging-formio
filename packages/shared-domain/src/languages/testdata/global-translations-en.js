const en = {
  "en": [
    {
      "id": "6183ff2454676700031b7cff", "name": "global", "scope": "global", "tag": "validering",
      "translations": {
        ...
        "Dette er ikke et gyldig {{field}}.": {"value": "This is not a valid {{field}}.", "scope": "global"},
        ...
        "{{field}} stemmer ikke med {{pattern}}": {"value": "{{field}} does not match {{pattern}}", "scope": "global"},
        "Du må fylle ut: {{field}}": {"value": "You must fill in: {{field}}", "scope": "global"},
        "{{field}} er ikke en gyldig dato.": {"value": "{{field}} is not a valid date.", "scope": "global"},
        "{{field}} er ikke en gyldig dag.": {"value": "{{field}} is not a valid day.", "scope": "global"},
    ...
    },
    {
      ...
      "translations": {
        ...
        "Vennligst sjekk at alle svarene dine er riktige. Hvis du finner noe som må korrigeres trykker du på «{{editAnswers}}» på bunnen av denne siden. Hvis alle svarene er riktige går du videre til steg 2.": {
          "value": "Please check that all your answers are correct. If you find something that needs to be corrected, press \"{{editAnswers}}\" at the bottom of this page. If all the answers are correct, proceed to step 2.",
          "scope": "global"
        },
        "Førstesidearket inneholder viktig informasjon om hvilken enhet i NAV som skal motta dokumentene, og hvilken adresse de skal sendes til.": {
          "value": "The cover sheet contains important information about the NAV unit that will receive the documents and the address to which the documents should be sent.",
          "scope": "global"
        },
        ...
        "som nevnt i punkt 2 over.": {"value": "as mentioned in point 2 above.", "scope": "global"},
        "Hva skjer videre?": {"value": "What happens next?", "scope": "global"},
        "Du hører fra oss så fort vi har sett på saken din. Vi tar kontakt med deg om vi mangler noe.": {
          "value": "You will hear from oss as soon as we have processed your case. We will be in touch if we are missing some documents.",
          "scope": "global"
        },
        ...
        "Klikk på «{{downloadApplication}}». Da åpnes den ferdig utfylte søknaden din i en ny fane i nettleseren. ": {
          "value": "Click \"{{downloadApplication}}\". This will open your completed application in a new tab in the browser.",
          "scope": "global"
        },
        ...
        "Etter at du har lastet ned og lagret søknaden din, må du laste den opp til NAV. Følg veiledningen i punkt 2 lenger ned på denne siden.": {
          "value": "After you have downloaded and saved your application, you must upload it to NAV. Follow the instructions in point 2 further down this page.",
          "scope": "global"
        },
        ...
        "Når du klikker på «Gå videre» åpnes det en ny side (krever innlogging) der du skal laste opp søknaden din.": {
          "value": "When you click on \"Proceed\", a new page will open (login required) where you will upload your application.",
          "scope": "global"
        },
        ...
        "Trykk på «Fyll ut og last opp».": {"value": "Press «Fyll ut og last opp».", "scope": "global"},
        ...
        "Deretter må du laste opp eventuelle vedlegg. Trykk på «Bekreft» for å gå videre til innsending av søknaden. Trykk på knappen «Send til NAV» nederst på siden for å sende inn søknaden din.": {
          "value": "Then you need to upload any attachments. Click on \"Bekreft\" to proceed to submitting the application. Click the \"Send til NAV\" button at the bottom of the page to submit your application.",
          "scope": "global"
        },
    ...
    {
      "id": "6183ccd633dfd600036b3e92", "name": "global", "scope": "global", "tag": "grensesnitt", "translations": {
        "Forrige": {"value": "Previous", "scope": "global"},
        "Neste": {"value": "Next", "scope": "global"},
        "Avbryt": {"value": "Cancel", "scope": "global"},
        "Er du sikker på at du vil avbryte?": {"value": "Are you sure you want to cancel?", "scope": "global"},
        "Legg til": {"value": "Add", "scope": "global"},
        "Fjern": {"value": "Remove", "scope": "global"},
        "Last ned søknaden": {"value": "Download application", "scope": "global"},
        "Gå tilbake": {"value": "Return", "scope": "global"},
        "Gå videre": {"value": "Proceed", "scope": "global"},
        ...
        "valgfritt": {"value": "optional", "scope": "global"},
        "Januar": {"value": "January", "scope": "global"},
        "Februar": {"value": "February", "scope": "global"},
        "Mars": {"value": "March", "scope": "global"},
        "April": {"value": "April", "scope": "global"},
        "Mai": {"value": "May", "scope": "global"},
        "Juni": {"value": "June", "scope": "global"},
        "Juli": {"value": "July", "scope": "global"},
        "August": {"value": "August", "scope": "global"},
        "September": {"value": "September", "scope": "global"},
        "Oktober": {"value": "October", "scope": "global"},
        "November": {"value": "Novemeber", "scope": "global"},
        "Desember": {"value": "December", "scope": "global"},
        "Måned": {"value": "Month", "scope": "global"},
        "Dag": {"value": "Day", "scope": "global"},
        "År": {"value": "Year", "scope": "global"}
      }
    }
  ]
};
