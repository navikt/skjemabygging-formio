export const grensesnitt = {
  ...
  introPage: {
    ...
    sendDigitalDescription: 'Det er enklest og raskest å sende digitalt.',
    ...
    sendOnPaperDescription: 'Du fyller ut skjemaet før du skriver det ut. Du trenger ikke å logge inn.',
