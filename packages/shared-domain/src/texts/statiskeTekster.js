export const statiske = {
  ...
  introPage: {
    ...
    paperDescriptionBold: "Du må fylle ut skjemaet digitalt, og deretter sende det i posten.",
    paperDescription:
  ...
  prepareLetterPage: {
    ...
    entityNoMatchError: "En feil har oppstått. Ingen relevante enheter funnet.",
