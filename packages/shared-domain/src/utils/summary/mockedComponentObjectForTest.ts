...
import { formioFormsApiUtils } from '../forms-api-backwards-compatibility';

const keyFromLabel = (label = '') => label.toLowerCase().replace(/\s/gi, '');
const createNavId = () => navFormioUtils.getRandomComponentId();
...
export { mockedComponentObjectForTest };
