import { formsApiTranslationMetadataUtils } from './formsApiTranslationMetadataUtils';

describe('FormsApiTranslation metadata', () => {
  describe('findMostRecentlyChanged', () => {
    it('should return the most recently changed translation', () => {
      ...
      const result = formsApiTranslationMetadataUtils.findMostRecentlyChanged(translations);
    ...
    it('should return undefined for empty array', () => {
      const result = formsApiTranslationMetadataUtils.findMostRecentlyChanged([]);
      expect(result).toBeUndefined();
    });

    it('should return undefined for undefined input', () => {
      const result = formsApiTranslationMetadataUtils.findMostRecentlyChanged(undefined);
      expect(result).toBeUndefined();
    });
  });
});
