...
export function PrepareSubmitPage({ form, submission }) {
  ...
  return (
    <ResultContent>
      <Sidetittel>Forbered innsending</Sidetittel>
      <ResultPanel border>
        <Systemtittel>1. For å gå videre må du laste ned PDF</Systemtittel>
        <Normaltekst>
      ...
      <ResultPanel border>
        <Systemtittel>2. Gå videre til innsending av søknaden</Systemtittel>
        <Normaltekst>
