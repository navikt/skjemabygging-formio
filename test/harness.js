...
// import navdesign from '../src/template'

Components.setComponents(AllComponents);
// Formio.use(navdesign); // TODO har problem med at templates i navdesign kun inneholder navnet på fil (f.eks. form.ejs, html.ejs), ikke innholdet i template'ene.
...
function onNext(cmp, event, cb) {
  if (typeof cmp.events !== "object") {
    throw Error("cmp.events should be an object");
  }
  if (typeof cmp.events.once !== "function") {
    throw Error("cmp.events.once should be a function");
  }
